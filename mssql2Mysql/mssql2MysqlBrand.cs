...
{
   public  class mssql2MysqlBrand
    {
        public  void main(Brand brand)
        {
            ...
            try
            {
                ...
                MySqlCommand ekle = new MySqlCommand("insert into brands (ID,Name,Description,State) values ('" + brand.ID + "','" + brand.Name.Replace("'","\\'") + "','"+brand.Description.Replace("'", "\\'") + "',0)", baglan);
