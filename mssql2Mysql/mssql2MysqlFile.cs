   ...
   public  class mssql2MysqlFile
    {
        public  void main(File file)
        {
            ...
            try
            {
                ...
                MySqlCommand ekle = new MySqlCommand("insert into files (RelativePath,FileName,DownloadURLPath,State,ProductID) values ('" + file.RelativePath+"','"+file.FileName+"','"+file.DownloadURLPath+"','"+file.State+ "','" + file.ProductID + "')", baglan);
